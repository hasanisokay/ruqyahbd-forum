const makeUrlsClickable = (text, theme) => {
  ...
  const urlRegex =
    /(?:https?:\/\/[^\s]+)|(www\.[^\s]+)|(https:\/\/play\.google\.com\/store\/apps\/details\?id=[^\s]+)|(facebook\.com[^\s]+|fb\.com[^\s]+)|(youtube\.com[^\s]+|youtu\.be[^\s]+)|((\b(?:[a-z0-9-]+\.)*[a-z0-9-]+\.com(?:\/[^\s]*)?(?:\b|$)))|((\b(?:[a-z0-9-]+\.)*[a-z0-9-]+\.org(?:\/[^\s]*)?(?:\b|$)))|((\b(?:[a-z0-9-]+\.)*[a-z0-9-]+\.net(?:\/[^\s]*)?(?:\b|$)))|((\b(?:[a-z0-9-]+\.)*[a-z0-9-]+\.io(?:\/[^\s]*)?(?:\b|$)))|((\b(?:[a-z0-9-]+\.)*[a-z0-9-]+\.gov(?:\/[^\s]*)?(?:\b|$)))|((\b(?:[a-z0-9-]+\.)*[a-z0-9-]+\.edu(?:\/[^\s]*)?(?:\b|$)))/gi;
